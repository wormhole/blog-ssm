    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item">
                <a href="javascript:;"><i class="layui-icon layui-icon-website"></i>&nbsp;&nbsp;博客首页</a>
            </li>
        </ul>
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="/static/custom/image/cam.png" class="layui-nav-img">
                    凉衫薄
                </a>
            ...
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" data-url="" data-title="个人中心" data-id="">个人中心</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
