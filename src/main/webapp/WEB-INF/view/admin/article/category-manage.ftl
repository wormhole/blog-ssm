...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/css/article/category-manage.css"/>
...
<script type="text/javascript" src="/static/admin/js/article/category-manage.js"></script>
</body>
</html>