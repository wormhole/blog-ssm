...
<div class="layui-card" id="pwd-conf">
    ...
    <div class="layui-card-body">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="oldPassword" class="layui-input" type="password" required id="old-password">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="newPassword" class="layui-input" type="password" required id="new-password">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="checkedPassword" class="layui-input" type="password" required id="checked-password">
            </div>
